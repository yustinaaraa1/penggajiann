...
<div class="container-fluid">
    ...
    <div class="card mx-auto" style="width: 35%">
    	...
    	<div class="card-body">
            ...
            <div class="col-sm-9">
            <select class="form-control" name="nama_pegawai" required="Tolong di klik dulu">
            ...
            <button style="width: 99%;" type="submit" class="btn btn-primary"><i class="fas fa-print"></i>Cetak Slip Gaji</button>
    	</div>
    </div>
    </form>
