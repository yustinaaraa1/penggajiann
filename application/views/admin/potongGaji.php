    ...
    <table class="table table-bordered table striped">
    	...
    	<?php $no=1; foreach($pot_gaji as $p):?>
    		<tr>
    			...
    			<td>
    				<center>
    					<a class="btn btn-sm btn-primary mb-2 mt-2" href="<?php echo base_url('admin/potonganGaji/updateData/'.$p->id) ?>"><i class="fas fa-edit">Update Data</i></a>
    					<a onclick="return confirm('Yakin Hapus')" class="btn btn-sm btn-danger mb-2 mt-2" href="<?php echo base_url('admin/potonganGaji/deleteData/'.$p->id); ?>"><i class="fas fa-trash">Delete Data</i></a>
    				</center>
    			</td>
